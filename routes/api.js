...
const adminOrSuperAdmin = verifyRole(['admin', 'super_admin'])

route.post('/account/link-google', linkGoogleAccount)
route.post('/account/unlink-google', unlinkGoogleAccount)

route.get("/users", getUsers)
route.post('/register-user', adminOrSuperAdmin, registerUser)
...
route.delete('/users/:id', adminOrSuperAdmin, deleteUser)
route.put('/users/:id', adminOrSuperAdmin, updateUser)
